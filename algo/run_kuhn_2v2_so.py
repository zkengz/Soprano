...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path_prefix", type=str, default="/home/zengzekeng/stoch_optim/results/mnt_results/2v2Kuhn", help="save path prefix")
    ...
    betsize = 1 
    rounds = [RoundInfo(holecards=1,boardcards=0,betsize=betsize,maxbets=[maxbets,maxbets,maxbets,maxbets])]
    ante = 1 
    blinds = None 
    ...
    print("scenario: 2v2Kuhn_r{}m{}: #terminal={}, #infoset={}, depth={}".format(rank, maxbets, solver.tree.num_terminal_nodes, len(solver.tree.information_sets), depth))
